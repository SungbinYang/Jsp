package kr.ac.mjc.sungbin.myapp.common.mvc;
...
/**
 * "@Controller" annotation이 붙어 있는 클래스들의 <br>
 * "@RequestMapping" annotation이 붙어 있는 메서드들을 매핑해서 (invokeMap)<br>
 * servletContext 영역에 저장
 * 
 * @author Jacob
 */
